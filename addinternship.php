                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                        <form method="post" action="addintern.php">
                            <label>Title</label>
                            <input type="text" required placeholder="title" name="title" id="title" />
                            <label>Description</label>
                            <textarea required name="desc" id="desc" ></textarea>
                            <label>Requirements</label>
                            <textarea required name="req" id="req" ></textarea>
                            <label>Tags ((,) comma seprated)</label>
                            <input type="text" required placeholder="tags" name="tags" id="tags" />
                            <button class="btn btn-sucess" type="sucess">Add internship</button>
                        </form>
                     </div>  
                </div>
            </div>
